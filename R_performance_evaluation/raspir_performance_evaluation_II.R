...
counts_df <- read_delim(
  "biological_samples/alignment_output/rawCounts_merged_samples_SRR7049258.csv", 
  ";", escape_double = FALSE, trim_ws = TRUE)
# normalised read counts
rpmm_df <- read_delim(
  "biological_samples/alignment_output/RPMM_merged_samples_SRR7049258.csv", 
  ";", escape_double = FALSE, trim_ws = TRUE)
...
S53_raspir <- read_csv(
  "biological_samples/raspir_output/final_stats.SRR7048708_S53_shotgun.trim.bwa.sorted.raspir.csv")
...
VS_B1_raspir <- read_csv(
  "biological_samples/raspir_output/final_stats.SRR7049045_VS.B1_shotgun.trim.bwa.sorted.raspir.csv")
...
MP79_raspir <- read_csv(
  "biological_samples/raspir_output/final_stats.SRR7049060_MP79_shotgun.trim.bwa.sorted.raspir.csv")
...
MP78_raspir <- read_csv(
  "biological_samples/raspir_output/final_stats.SRR7049061_MP78_shotgun.trim.bwa.sorted.raspir.csv")
...
MP74_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049072_MP74_shotgun.trim.bwa.sorted.raspir.csv")
...
S47_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049073_S47_shotgun.trim.bwa.sorted.raspir.csv")
...
MP45_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049084_MP45_shotgun.trim.bwa.sorted.raspir.csv")
...
MP44_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049085_MP44_shotgun.trim.bwa.sorted.raspir.csv")
...
MP47_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049086_MP47_shotgun.trim.bwa.sorted.raspir.csv")
...
MP46_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049087_MP46_shotgun.trim.bwa.sorted.raspir.csv")
...
MP41_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049088_MP41_shotgun.trim.bwa.sorted.raspir.csv")
...
MP43_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049090_MP43_shotgun.trim.bwa.sorted.raspir.csv")
...
MP42_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049091_MP42_shotgun.trim.bwa.sorted.raspir.csv")
...
MP49_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049096_MP49_shotgun.trim.bwa.sorted.raspir.csv")
...
MP48_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049097_MP48_shotgun.trim.bwa.sorted.raspir.csv")
...
FP55_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049154_FP55_shotgun.trim.bwa.sorted.raspir.csv")
...
FP58_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049155_FP58_shotgun.trim.bwa.sorted.raspir.csv")
...
FP57_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049156_FP57_shotgun.trim.bwa.sorted.raspir.csv")
...
FP60_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049157_FP60_shotgun.trim.bwa.sorted.raspir.csv")
...
FP59_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049158_FP59_shotgun.trim.bwa.sorted.raspir.csv")
...
AS_B5_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049159_AS.B5_shotgun.trim.bwa.sorted.raspir.csv")
...
AS_B4_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049160_AS.B4_shotgun.trim.bwa.sorted.raspir.csv")
counts_df_raspir$AS_B4_raspir <- ifelse(rownames(counts_df_raspir) %in% AS_B4_raspir$Species,
                                      counts_df_raspir$AS.B4, 0)
rpmm_df_raspir$AS_B5_raspir <- ifelse(rownames(rpmm_df_raspir) %in% AS_B5_raspir$Species,
                                      rpmm_df_raspir$AS.B5, 0)

S54_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049161_S54_shotgun.trim.bwa.sorted.raspir.csv")
...
S55_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049162_S55_shotgun.trim.bwa.sorted.raspir.csv")
...
S57_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049164_S57_shotgun.trim.bwa.sorted.raspir.csv")
...
S58_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049165_S58_shotgun.trim.bwa.sorted.raspir.csv")
...
S59_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049166_S59_shotgun.trim.bwa.sorted.raspir.csv")
...
S60_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049167_S60_shotgun.trim.bwa.sorted.raspir.csv")
...
S61_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049168_S61_shotgun.trim.bwa.sorted.raspir.csv")
...
S62_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049169_S62_shotgun.trim.bwa.sorted.raspir.csv")
...
S63_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049170_S63_shotgun.trim.bwa.sorted.raspir.csv")
...
FP73_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049173_FP73_shotgun.trim.bwa.sorted.raspir.csv")
...
FP74_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049174_FP74_shotgun.trim.bwa.sorted.raspir.csv")
...
FP76_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049183_FP76_shotgun.trim.bwa.sorted.raspir.csv")
...
FP75_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049184_FP75_shotgun.trim.bwa.sorted.raspir.csv")
...
FP80_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049187_FP80_shotgun.trim.bwa.sorted.raspir.csv")
...
FP79_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049188_FP79_shotgun.trim.bwa.sorted.raspir.csv")
...
FP64_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049201_FP64_shotgun.trim.bwa.sorted.raspir.csv")
...
FP63_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049202_FP63_shotgun.trim.bwa.sorted.raspir.csv")
...
FP62_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049225_FP62_shotgun.trim.bwa.sorted.raspir.csv")
...
FP61_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049226_FP61_shotgun.trim.bwa.sorted.raspir.csv")
...
VS_B4_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049247_VS.B4_shotgun.trim.bwa.sorted.raspir.csv")
...
VS_B3_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049248_VS.B3_shotgun.trim.bwa.sorted.raspir.csv")
...
MP71_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049253_MP71_shotgun.trim.bwa.sorted.raspir.csv")
...
MP70_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049255_MP70_shotgun.trim.bwa.sorted.raspir.csv")
...
MP73_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049256_MP73_shotgun.trim.bwa.sorted.raspir.csv")
...
MP72_raspir <- read_csv("biological_samples/raspir_output/final_stats.SRR7049257_MP72_shotgun.trim.bwa.sorted.raspir.csv")
...
raspir_list_S <- c(
  ...
  "S60_raspir", "S61_raspir", "S62_raspir", 
  "S63_raspir")

raspir_list_MP <- c(
  "MP79_raspir", "MP78_raspir", "MP74_raspir", 
  "MP45_raspir", "MP44_raspir", "MP47_raspir", 
  "MP46_raspir", "MP41_raspir", "MP43_raspir",
  "MP42_raspir", "MP49_raspir", "MP48_raspir", 
  "MP71_raspir", "MP70_raspir", "MP73_raspir",
  "MP72_raspir")

raspir_list_FP <- c(
  "FP55_raspir", "FP58_raspir",  "FP57_raspir", 
  "FP60_raspir","FP59_raspir", "FP73_raspir", 
  "FP74_raspir", "FP76_raspir", "FP75_raspir", 
  "FP80_raspir", "FP79_raspir", "FP64_raspir", 
  "FP63_raspir", "FP62_raspir", "FP61_raspir")
...
blank_c <- c("AS.B5", "AS.B4", "VS.B3", "VS.B4", "VS.B1")
...
#ggsave("images/Supplementary_Figure_03.tif",
...
the_samples <- c("AS.B5", "AS.B4", "VS.B3", "VS.B4", "VS.B1",
                 "MP49", "MP70", "MP78", "MP71", "MP46",
                 "FP55", "FP80", "FP63", "FP75", "FP59",
                 "S62", "S57", "S60", "S47", "S54")
...
reads_qc_passed_total <- c(
  ...
  42064, 72298, 49616, 38124, 77314,
  64946, 59194, 58918, 144840, 74792,
  4223982, 1597616, 3935052, 877178, 1141774)

ralstonia_reads <- c(
  654, 337, 1093, 1267, 589, 
  188, 455, 354, 288, 192, 
  404, 223, 323, 430, 385, 
  184, 248, 242, 165, 85)

seqdepth_ralstonia_df <- data.frame(cbind(
  the_samples, sample_type, 
  reads_qc_passed_total, ralstonia_reads))
...
#ggsave("images/Supplementary_Figure_04.tif",
...
sputum_raspir_raspir <- c(
  "S53_raspir", "S47_raspir", "S54_raspir", 
  "S55_raspir", "S57_raspir", "S58_raspir", 
  "S59_raspir", "S60_raspir", "S61_raspir", 
...
core_plot <-
  ...
  x=type, y=similarity)) +
  geom_boxplot() +
  geom_jitter(aes(colour=type),width=0.03, size=3, alpha=0.5) +
...
#ggsave("images/Supplementary_Figure_05.tif",
